        ...
        <div className="service-page">
            ...
            <div className="section rectangle02">
                <div className="text-container">
                    <h3 className="titre1">Unübertroffene Servicequalität</h3>
            ...
            <div className="section white-section">
                <div className="box">
                    <h4 className="titre2">Unser Engagement für Exzellenz</h4>
                ...
                <div className="box">
                    <h4 className="titre3">Bewährte Erfahrung</h4>
                ...
                <div className="box">
                    <h4 className="titre4">Höchster Professionalität</h4>
